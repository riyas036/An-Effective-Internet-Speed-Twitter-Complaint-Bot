...
service = Service('C:\\Users\\robertp\\Development\\chromedriver.exe')  #('path/to/chromedriver')
...
class InternetSpeedTwitterBot:
    def __init__(self):
        ...
        try:
            ...
            driver.find_element(By.CSS_SELECTOR,'input[class="r-30o5oe r-1niwhzg r-17gur6a r-1yadl64 r-deolkf r-homxoj r-poiln3 r-7cikom r-1ny4l3l r-t60dpp r-1dz5y72 r-fdjqy7 r-13qz1uu"]').send_keys(username)
            time.sleep(0.5)
            driver.find_element(By.CSS_SELECTOR,'div[class="css-18t94o4 css-1dbjc4n r-sdzlij r-1phboty r-rs99b7 r-peo1c r-1ps3wis r-1ny4l3l r-1guathk r-o7ynqc r-6416eg r-lrvibr"]').click()
    ...
    def send_tweet(self, tweet_text):
        time.sleep(5)
        print(tweet_text)
        driver.find_element(By.CSS_SELECTOR,'div[class="public-DraftStyleDefault-block public-DraftStyleDefault-ltr"]').send_keys(tweet_text)

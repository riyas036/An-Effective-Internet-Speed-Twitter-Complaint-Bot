...
class GetInternetSpeed:
    def __init__(self):
        ...
        self.down = driver.find_element(By.CSS_SELECTOR,'span[class="result-data-large number result-data-value download-speed"]')
        self.up = driver.find_element(By.CSS_SELECTOR,'span[class="result-data-large number result-data-value upload-speed"]')
